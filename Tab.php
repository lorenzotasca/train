...
<body>
    ...
    <?php
        ...
        // E IN BASE A QUEL LIVELLO, PIù è ELEVATO, PIù AUMENTA LA DIFFICOLTà E NUMERO DI ALLENAMENTI (ANCHE GIORNALIERI)
        // (1 e 2 = UP TO 1 ALLENAMENTO GIORNALIERO, 3 = UP TO 2 ALLENAMENTI GIORNALIERI, 4 = UP TO 3 ALLENAMENTI GIORNALIERI, 5 = UP TO 4 ALLENAMENTI GIORNALIERI)
        // E IN BASE A QUEL LIVELLO, PIù è ELEVATO, PIù AUMENTA IL NUMERO DI GIORNI DI ALLENAMENTO SETTIMANALI
        // (1 = 3 GIORNI DI ALLENAMENTO SETTIMANALI, 2 = 4 GIORNI DI ALLENAMENTO SETTIMANALI, 3 = 5 GIORNI DI ALLENAMENTO SETTIMANALI, 4 = 6 GIORNI DI ALLENAMENTO SETTIMANALI, 5 = 7  GIORNI DI ALLENAMENTO SETTIMANALI)
        ...
        foreach ($orari as $ora) {
            ...
            foreach ($orari_settimanali as $giorno) {
                ...
                // LA PERCENTUALE DEVE ESSERCI ANCHE QUELLA SETTIMANALE, PERCHè AD ESEMPIO, DEDICATION=1 -> NON TUTTI I GIORNI FA ALLENAMENTO E NON TANTI QUANTI DEDICATION=5
